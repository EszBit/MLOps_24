# Implement training and evaluation of your model in main.py script.
# The main.py script should be able to take an additional subcommands
# indicating if the model should train or evaluate.
